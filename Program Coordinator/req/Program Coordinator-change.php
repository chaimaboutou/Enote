...
if (isset($_SESSION['idUtilisateur']) && 
    ...
    if (isset($_POST['programCoord_pass']) &&
    ...
    $programCoord_pass = $_POST['programCoord_pass'];
    ...
    if (empty($programCoord_pass)) {
        ...
        header("Location: ../Program Coordinator-edit.php?perror=$em&$data");
        exit;
    }else if (!programCoordPasswordVerify($programCoord_pass, $conn, $id)) {
