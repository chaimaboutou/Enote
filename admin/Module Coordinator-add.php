...
if (isset($_SESSION['idUtilisateur']) && 
    ...
    $address ='' ;
       ...
       if (isset($_GET['emoveProfessor'])) $id_Module_Coordinator = $_GET['id_professor'];
...
<body>
    <?php 
     ...
     <div class="container mt-5">
        <a href="Module Coordinator.php"
           ...
           <form method="post" class="shadow p-3 mt-5 ms-5 form-w" action="req/Module Coordinator-add.php">
    <h3>Add New Module Coordinator</h3>
    <hr>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" value="<?=$id_Module_Coordinator?>" name="idUtilisateur" placeholder="mc-number">
    </div>
    ...
    <button type="submit" class="btn btn-primary">Add Module Coordinator</button>
</form>
