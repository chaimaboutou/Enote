...
if (isset($_SESSION['idUtilisateur']) && 
    ...
    $address ='' ;
       ...
       if (isset($_GET['emoveProfessor'])) $id_Program_Coord = $_GET['id_professor'];
...
<body>
    <?php 
     ...
     <div class="container mt-5">
        <a href="Program Coordinator.php"
           ...
           <form method="post" class="shadow p-3 mt-5 ms-5 form-w" action="req/Program Coordinator-add.php">
    <h3>Add New Program Coordinator</h3>
    <hr>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" value="<?=$id_Program_Coord?>" name="idUtilisateur" placeholder="pc-number">
    </div>
    ...
    <button type="submit" class="btn btn-primary">Add Program Coordinator</button>
</form>
